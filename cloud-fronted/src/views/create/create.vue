<template>
    <PageLayout tag="短链接创建工具" title="创建您的短链接" description="输入您想要缩短的链接，快速生成短链接">
        <!-- 创建短链卡片 -->
        <div class="max-w-2xl mx-auto opacity-0 translate-y-5 transition-all duration-800  ease-out motion-reduce:opacity-100 motion-reduce:translate-y-0 motion-reduce:transition-none delay-300"
                ...
                <div class="relative bg-white rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6">
                        <form @submit.prevent="createShortLink" class="space-y-6">
                            ...
                            <!-- 分组选择 - 新增 -->
                            <div>
                                <label for="groupId" class="block text-sm font-medium text-gray-700 mb-1">选择分组</label>
                                <div class="relative">
            ...
            <!-- 结果展示区域 -->
            <div v-if="shortLinkResult"
                class="mt-8 opacity-0 translate-y-5 transition-all duration-800 ease-out motion-reduce:opacity-100 motion-reduce:translate-y-0 motion-reduce:transition-none"
                :class="{ 'opacity-100 translate-y-0': true }">
                        ...
                        <div class="space-y-4 md:space-y-5">
                            ...
                            <div v-if="shortLinkResult.qrCode" class="text-center">
                                ...
                                <div class="inline-block bg-white p-2 border border-gray-200 rounded-lg">
                                    <img :src="shortLinkResult.qrCode" alt="QR Code" class="h-24 w-24 md:h-32 md:w-32">
                                </div>
                            </div>
                        </div>
            ...
            <!-- 使用说明卡片 -->
            <div v-if="!shortLinkResult"
                class="mt-12 opacity-0 translate-y-5 transition-all duration-800 delay-500 ease-out motion-reduce:opacity-100 motion-reduce:translate-y-0 motion-reduce:transition-none"
                :class="{ 'opacity-100 translate-y-0': true }">
