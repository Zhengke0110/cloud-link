<template>
    <div class="animate-fadeIn bg-gradient-to-br from-blue-50 to-indigo-100 text-12161e h-full overflow-hidden motion-reduce:animate-none">
        <!-- 添加 SVG 背景 -->
        ...
        <div class="bg-transparent text-gray-900 h-screen overflow-y-auto relative z-10">
            <div class="relative min-h-screen flex justify-center items-center box-border">
                ...
                <div class="relative flex-grow">
                    <div class="animate-slideUp max-w-100 w-full my-0 mx-auto py-0 px-5 box-border transform transition-all duration-300">
                        <RouterView />
                    </div>
                </div>
                <p
                    class="transition duration-200 m-0 absolute z-10 left-2/4 text-center translate-x-[-50%] bottom-6 text-[10px] max-w-[260px] text-gray-500 hover:text-gray-600">
                    This site is authenticate by supabase.com and the Supabase

                    <a class="no-underline transition duration-300 text-indigo-600 hover:text-indigo-700" target="_blank"
                        href="#" rel="noreferrer">
                        Privacy Policy
                    </a>
                    and
